...
//              SharedPrefs.removeKey(Constants.PrefKeys.DOWNLOAD_ID_ + id);
    ...
    public static void backup(File EXPORT_REALM_PATH, String EXPORT_REALM_FILE_NAME) {
    ...
    public static void restore(Activity activity, File EXPORT_REALM_PATH, String EXPORT_REALM_FILE_NAME, String IMPORT_REALM_FILE_NAME) {
