...
public class UnzipUtil {
    ...
    public static void unzipFile(final File zipfile1, Context context, final String languageName, final String languageCode,
                                 final String versionCode, final String versionName, String source, String license, int year) {
        ...
        try {
            ...
            UtilFunctions.startParseService(context, outputDir, languageName, languageCode, versionCode, versionName, source, license, year);
